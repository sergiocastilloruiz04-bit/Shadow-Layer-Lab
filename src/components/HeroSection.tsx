  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, hsl(0 85% 50% / 0.3) 0%, transparent 70%)",
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        <h1
          className="text-5xl md:text-7xl lg:text-8xl font-bold font-display tracking-tighter mb-6 text-glow text-primary"
          style={{ animation: "flicker 8s infinite" }}
        >
          Invisible.<br />
          Untraceable.<br />
          <span className="text-foreground">The Shadow Layer.</span>
        </h1>
